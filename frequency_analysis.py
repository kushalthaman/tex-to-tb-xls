...
simple_df = df[df['Template'].isin(simple_templates)].groupby('Template').sum()['Token Frequency'].sort_values(ascending=False)
complex_df = df[df['Template'].isin(complex_templates)].groupby('Template').sum()['Token Frequency'].sort_values(ascending=False)
